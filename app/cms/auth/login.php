...
<head>
    ...
    <title>Tailwind CSS Sign in/Login Page - Windster</title>
    ...
    <meta name="twitter:title" content="Tailwind CSS Sign in/Login Page - Windster">
    ...
    <!-- Facebook -->
    <meta property="og:url" content="https://themewagon.github.io/windster/authentication/sign-in/">
    <meta property="og:title" content="Tailwind CSS Sign in/Login Page - Windster">
        ...
        <div class="mx-auto md:h-screen flex flex-col justify-center items-center px-6 pt-8 pt:mt-0">
            ...
            <div class="bg-white shadow rounded-lg md:mt-0 w-full sm:max-w-screen-sm xl:p-0">
                <div class="p-6 sm:p-8 lg:p-16 space-y-8">
                    ...
                    <form action="/web-retail-rev/public/index.php?page=process_login" method="POST">

                        <div>
                            <label for="username" class="text-sm font-medium text-gray-900 block mb-2">Username</label>
                            <input type="username" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="name@company.com" required style="margin-bottom: 30px;">
                        </div>
                        <div>
                            <label for="password" class="text-sm font-medium text-gray-900 block mb-2">Password</label>
                            <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required style="margin-bottom: 40px;">
                        </div>
                        <button type="submit" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-base px-5 py-3 w-full sm:w-auto text-center">Login as Admin</button>
                        <div class="text-sm font-medium text-gray-500">
                            <!-- Not registered? <a href="https://themewagon.github.io/windster/authentication/sign-up/" class="text-teal-500 hover:underline">Create account</a> -->
                        </div>
                    </form>
                </div>
            </div>
