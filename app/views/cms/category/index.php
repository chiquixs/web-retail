            ...
            <table class="w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="p-3 text-left text-xs font-medium text-gray-500 uppercase">Description</th>
                    ...
                    <?php else: ?>
                        <?php foreach ($data['categories'] as $cat): ?>
                            <tr class="hover:bg-gray-100">
                                <td class="p-3 text-sm"><?= htmlspecialchars($cat['name']) ?></td>
                                <td class="p-3 text-sm text-gray-500"><?= htmlspecialchars($cat['description'] ?? '-') ?></td>
                                <td class="p-3 text-sm">
                                    <button class="edit-category-btn bg-cyan-600 text-white px-3 py-2 rounded text-xs mr-2"
                                    ...
                                    <button class="delete-category-btn bg-red-600 text-white px-3 py-2 rounded text-xs"
                                        data-id="<?= $cat['id_category'] ?>">
                                        Delete
                                    </button>
                                </td>
    ...
    <div class="relative w-full max-w-xl px-4 h-full md:h-auto">
        <div class="bg-white rounded-lg shadow relative">
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                <button type="button" id="btn-save-add-category" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    Add Category
                </button>
                <button type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 text-center" data-modal-toggle="add-category-modal">
                    Cancel
                </button>
            </div>
        </div>
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full" id="edit-category-modal">
    <div class="relative w-full max-w-xl px-4 h-full md:h-auto">
        <div class="bg-white rounded-lg shadow relative">
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                <button type="button" id="btn-save-edit-category" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    Update Category
                </button>
                <button type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 text-center" data-modal-toggle="edit-category-modal">
                    Cancel
                </button>
            </div>
        </div>
    ...
    <div class="relative w-full max-w-md px-4 h-full md:h-auto">
        <div class="bg-white rounded-lg shadow relative">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <button id="btn-confirm-delete-category" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2">
                    Yes, I'm sure
                </button>
                <button type="button" class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-category-modal">
                    No, cancel
                </button>
            </div>
        </div>
